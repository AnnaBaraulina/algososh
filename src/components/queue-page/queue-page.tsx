  ...
  return (
    <SolutionLayout title="Очередь">
      <div className={style.form}>
        <Input maxLength={4} isLimitText onChange={onChange} value={inputValue} disabled={queue.isFull()}/>
        <Button text='добавить' data='add-button' type='button' isLoader={loader.add} onClick={addElement} disabled={!!!inputValue || queue.isFull()}/>
        <Button text='удалить' data='delete-button' type='button' isLoader={loader.delete} onClick={deleteElement} disabled={queue.isEmpty()}/>
        <Button text='очистить' data='clear-button' type='button' onClick={clearElements} isLoader={loader.clear} disabled={queue.isEmpty()}/>
      </div>
